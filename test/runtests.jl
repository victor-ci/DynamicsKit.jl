...
const ALL_TEST_FILES = [
    ...
    "test_border_collision.jl",
    "test_filippov.jl",
    "test_branch_families.jl",
    "test_branch_reachability.jl",
    "test_tolerance_fields.jl",
    "test_mode_assimilation.jl",
    "test_hardware_acceptance.jl",
    "test_skeleton.jl",
    "test_atlas.jl",
    "test_adaptive_map.jl",
    "test_basins_map_refine.jl",
    "test_robust_chaos.jl",
    "test_chaos_design.jl",
...
const TEST_TARGETS = Dict(
    ...
    "homoclinic" => ["test_homoclinic.jl"],
    "map-special-points" => ["test_map_special_points.jl"],
    "map_special_points" => ["test_map_special_points.jl"],
    "border-collision" => ["test_border_collision.jl"],
    "border_collision" => ["test_border_collision.jl"],
    "filippov" => ["test_filippov.jl"],
    "branch-families" => ["test_branch_families.jl"],
    "branch_families" => ["test_branch_families.jl"],
    "branch-reachability" => ["test_branch_reachability.jl"],
    "branch_reachability" => ["test_branch_reachability.jl"],
    "tolerance-fields" => ["test_tolerance_fields.jl"],
    "tolerance_fields" => ["test_tolerance_fields.jl"],
    "mode-assimilation" => ["test_mode_assimilation.jl"],
    "mode_assimilation" => ["test_mode_assimilation.jl"],
    "hardware-acceptance" => ["test_hardware_acceptance.jl"],
    "hardware_acceptance" => ["test_hardware_acceptance.jl"],
    "skeleton" => ["test_skeleton.jl"],
    "atlas" => ["test_atlas.jl"],
    "adaptive-map" => ["test_adaptive_map.jl"],
    "adaptive_map" => ["test_adaptive_map.jl"],
    ...
    "chaos-design" => ["test_chaos_design.jl"],
    "chaos_design" => ["test_chaos_design.jl"],
